...
SECRET_KEY = 'django-insecure-zf-ed#ood@*mw^8po=lze_n_c195*_pl8hjwa#b%hei@41s2@x'
...
ORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:8000",
    "http://0.0.0.0:5500/authentication-frontend.html",  # Adjust based on your frontend server port
]
